...
public class BookDAO {
    ...
    //Join'им таблицы Book и Person и получаем человека, которому принадлежит кника с указанным id
    ...
    //Освобождаем книгу (этот метод ывзввается, когда человек возвращает книгу в библиотеку)
